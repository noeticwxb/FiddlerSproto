...
{
    public class DecodeRequest : Inspector2, IRequestInspector2, IBaseInspector2
    {
        private bool m_bDirty;
        private bool m_bReadOnly;
        private byte[] m_entityBody;
        private HTTPRequestHeaders m_RequestHeaders;
        ...
        {
            //如果需要解密
            String path = this.m_RequestHeaders.RequestPath;
